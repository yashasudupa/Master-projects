/*
 *	msp -- OTAWA loader to support MSP430 ISA with GLISS2
...
#	include <msp/grt.h>
#	include <msp/api.h>
#	include <msp/config.h>
#	include <msp/used_regs.h>
}
...
/*
 * Configuration
 * * MSP_SIM -- integrate functional simulator in MSP plugin.
 */

#define VERSION "2.1.0"
OTAWA_LOADER_ID("msp", VERSION, OTAWA_DATE);

/**
 * @class Info
 * Information provided by an MSP430 loader supporting GLISS2 engine.
 */
 ...
 * @return		Decoded data castable to msp_inst_t *.
 */
...
/**
 * Identifier used to retrieve MSP specific information.
 * Must be accessed dynamically because MSP loader is a plugin !
 *
 * @par Hooks
 * @li Process from MSP loader.
 */
Identifier <Info *> Info::ID("otawa::msp::Info::ID", 0);
...
#ifdef MSP_SIM
#	ifndef MSP_MEM_SPY
#		error "To support simulation, MSPv5T must be compiled with option WITH_MEM_SPY."
#	endif
...
const Platform::Identification Platform::ID("msp-none-eabi-");
...
typedef enum { NONE = 0, MSP = 1, DATA = 3 } area_t;
...
/**
 * Identifier used to retrieve MSP430 specific information.
 * Must be accessed dynamically because MSP loader is a plugin !
 *
 * @par Hooks
 * @li Process from MSP430 loader.
 */
Identifier <Info *> Info::ID("otawa::msp::Info::ID", 0);
...
#ifdef MSP_SIM
#	ifndef MSP_MEM_SPY
#		error "To support simulation, MSP430 must be compiled with option WITH_MEM_SPY."
#	endif
class SimState: public otawa::SimState {
public:
...
// alias table
static string table[] = { "elf_40", "msp" };
static elm::genstruct::Table<string> loader_aliases(table, 1);

// loader definition
class Loader: public otawa::Loader {
public:
	Loader(void): otawa::Loader("msp", Version(VERSION), OTAWA_LOADER_VERSION, loader_aliases) {
	}

	virtual CString getName(void) const { return "msp"; }
...
public:
	Plugin(void): otawa::ProcessorPlugin("otawa/msp", Version(VERSION), OTAWA_PROC_VERSION) {
	}
};
